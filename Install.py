...
urllib.request.urlretrieve("https://github.com/joostvangils/BPMN_RPA/blob/main/BPMN_RPA/BPMN%20RPA%20Mouse.xml", f'{installdir}Mouse.xml')
urllib.request.urlretrieve("https://github.com/joostvangils/BPMN_RPA/blob/main/BPMN_RPA/BPMN%20RPA%20Shapes.xml", f'{installdir}Shapes.xml')
urllib.request.urlretrieve("https://github.com/joostvangils/BPMN_RPA/blob/main/BPMN_RPA/BPMN%20RPA%20System.xml", f'{installdir}System.xml')
urllib.request.urlretrieve("https://github.com/joostvangils/BPMN_RPA/blob/main/BPMN_RPA/BPMN%20RPA%20Window.xml", f'{installdir}Window.xml')
urllib.request.urlretrieve("https://github.com/joostvangils/BPMN_RPA/blob/main/BPMN_RPA/BPMN%20RPA%20Keyboard.xml", f'{installdir}Keyboard.xml')
